...
HD_PWD='C:/Users/Docencia/Desktop/Reyes-Nieves/VHDL-ALU/project_1.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log ALU_N_Bits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_N_Bits.tcl -notrace
