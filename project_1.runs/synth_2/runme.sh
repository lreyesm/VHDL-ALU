...
HD_PWD='C:/Users/Docencia/Desktop/Reyes-Nieves/VHDL-ALU/project_1.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log ALU_N_Bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_N_Bits.tcl
